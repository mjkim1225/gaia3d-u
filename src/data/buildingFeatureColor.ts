export default {
    DEFAULT: {
        name: "기본/색상분리없음",
        legend: [{ color: '#D3D3D3', code: 'default', title: '기본' }]
    },
    BLDH_HGT:
        {
            name: '건물높이',
            legend: [
                { color: '#382A54', min: 0, max: 12, title: '0' },
                { color: '#5A22C8', min: 12, max: 31, title: '12' },
                { color: '#A675BE', min: 31, max: 60, title: '31' },
                { color: '#F0D37B', min: 60, max: 120, title: '60' },
                { color: '#FFCD00', min: 120, max: 180, title: '120' },
                { color: '#F7FF00', min: 180, max: 999999, title: '180' },
            ]
        },
    BPRP_SE:
        {
    ...
    USECON_DE: {
        name: '사용승인 일',
        legend: [
            { color: '#D3D3D3', min: 0, max: 10000000, title: '기록없음' },
...
// /**
//  * export default {
//  *     DEFAULT: [{ color: '#D3D3D3', code: 'default', title: '기본' }],
//  *     BPRP_SE: [
//  *         { color: '#FFFAFA', code: 'BDU001', title: '주거용단독주택' },
//  *         { color: '#4682B4', code: 'BDU002', title: '주거용공동주택' },
//  *         { color: '#D2B48C', code: 'BDU003', title: '제1종근린생활시설' },
